...
REM
REM Generated by Vivado on Wed May 06 15:56:05 +0300 2026
...
echo "xvhdl --incr --relax -prj Test_Top_level_vhdl.prj"
call xvhdl  --incr --relax -prj Test_Top_level_vhdl.prj -log xvhdl.log
