...
REM
REM Generated by Vivado on Fri May 15 09:24:39 +0300 2026
...
echo "xvhdl --incr --relax -prj Simulate_processor_complete_vhdl.prj"
call xvhdl  --incr --relax -prj Simulate_processor_complete_vhdl.prj -log xvhdl.log
