...
REM
REM Generated by Vivado on Mon May 18 01:49:59 +0300 2026
...
echo "xvhdl --incr --relax -prj TEST_PC_TOP_LEVEL_vhdl.prj"
call xvhdl  --incr --relax -prj TEST_PC_TOP_LEVEL_vhdl.prj -log xvhdl.log
