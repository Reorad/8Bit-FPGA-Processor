...
REM
REM Generated by Vivado on Mon May 04 20:21:27 +0300 2026
...
echo "xvhdl --incr --relax -prj ALU_8_BITS_tb_vhdl.prj"
call xvhdl  --incr --relax -prj ALU_8_BITS_tb_vhdl.prj -log xvhdl.log
